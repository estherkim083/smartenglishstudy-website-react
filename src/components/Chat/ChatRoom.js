  ...
  return (
    <div className={classNames(classes.root, classes.content, showMobileDetail ? classes.detailPopup : '')}>
      ...
      <ul className={classes.chatList} id="roomContainer">
        {dataChat.size > 0 ? getChat(dataChat) : (<Typography display="block" variant="caption" className={classes.textCenter}>{'You haven\'t made any conversation yet'}</Typography>)}
      </ul>
