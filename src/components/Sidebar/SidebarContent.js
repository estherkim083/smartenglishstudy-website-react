...
function SidebarContent(props) {
  ...
  const [dummyUserName, setDummyUserName] = useState(null);
  ...
  useEffect(() => {
    setDummyUserName(localStorage.getItem("user_name"));
  ...
  return (
    <div className={classNames(classes.drawerInner, !drawerPaper ? classes.drawerPaperClose : '')}>
      <div className={classes.drawerHeader}>
        <NavLink to="/smartenglishstudy-website-react" className={classNames(classes.brand, classes.brandBar, turnDarker && classes.darker)}>
        ...
        {isLogin && (
          ...
          >
            ...
            />
            <div>
              <h4 style= {{fontFamily:"CookieRun-Regular"}}>{dummyUserName}</h4>
              <Button size="small" onClick={openMenuStatus} style= {{fontFamily:"CookieRun-Regular"}}>
