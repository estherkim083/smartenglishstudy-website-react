...
import {
  ListeningMenu,
  ListeningCreateScripts,
  ListeningViewScripts,
  ReadingCreate,
  ReadingView,
  ReadingMenu,
  ReadingVocab,
  ...
  EditorPageView,
  EditorPageOnlyView,
  BookWritingBoardList,
  BookWritingRoomCreate,
  BookWritingView,
  BookWriting,
  Quiz,
  CreateQuiz,
  ...
  return (
    <Dashboard history={history} changeMode={changeMode}>
      <Switch>
        ...
        <Route
          exact
          path="/listening/listening-create-scripts/:id?"
          component={ListeningCreateScripts}
        />
        <Route
          exact
          path="/listening/listening-view-scripts/:id"
          component={ListeningViewScripts}
        />
        <Route
          exact
          path="/reading/create/:id?/:myinbox?"
        ...
        <Route
          exact
          path="/quiz/take-quiz/result/:id"
          component={SolveRoomResultView}
        />
        {/* <Route exact path='/quiz/take-quiz/solve/:id' component={SolveRoomView}/>   */}
        <RefreshRoute
          exact
          path="/quiz/take-quiz/solve/:id"
          redirectionPath="/quiz/take-quiz"
          component={SolveRoomView}
        />
        <Route exact path="/quiz/my-score" component={QuizMyScoreList} />
        <Route exact path="/quiz/my-score/:id" component={QuizScoreView} />
        <Route
          exact
          path="/quiz/student-score"
          component={QuizStudentScoreList}
        />
        ...
        <Route
          exact
          path="/vocab/quiz-memorization/take-quiz"
          component={VocabQuizTakeQuiz}
        />
        <Route
          exact
          path="/vocab/quiz-memorization/result"
          component={VocabQuizResult}
        />
      </Switch>
    </Dashboard>
  );
