    ...
    return (
      ...
      <Grid item xs ={4}> 
            <div style= {{display: 'flex', flexDirection: 'column', marginTop: "0"}}>
              ...
              <Typography component="h1" style={{fontFamily:'CookieRun-Regular', fontSize: "16px", marginTop: "20px"}}>
              공부하고자 하는 영어 리스닝, 리딩, 영어 
              </Typography>
              <Typography display="block" component="h1" style={{fontFamily:'CookieRun-Regular', fontSize: "16px", }}>
      ...
      >
        ...
        <Grid item xs ={5}> 
              <img src={circleshoes} width="500px" height="400px" style={{marginTop:'100px'}}/>
        </Grid>
        <hr width="100%" 
          style={{marginTop:'50px', marginLeft:'-30px'}}
          size="1px" 
          align="center"/>
        <Grid item xs ={12}> 
              <Typography component="h1" style={{fontFamily:'CookieRun-Regular', fontSize: "30px", fontWeight: "bold", marginTop: "20px"}}>
                  Several Features
              </Typography>
        </Grid>
        <Grid item xs ={5}> 
