    ...
    <div className={classes.root}>
      ...
      >
        ...
        <Grid item xs={5} className="reveal fade-bottom">
          ...
          >
            다른 유저들과 방을 공유하여, 에세이를 서로 첨삭해주고, 피드백해줄수
            있는 공간입니다.
          </Typography>
          <Typography
            display="block"
          ...
          >
            첨삭자료실에서 확인할수있으며, 첨삭자로 지정되지 않아도 에세이 열람
            및 comment로 피드백을 받을수 있습니다.
          </Typography>
        </Grid>
        <Grid item xs={6} className="reveal fade-bottom">
          ...
          >
            Reading, Listening 두가지 유형으로 각 유형별 문제들을 출제하고
            공유할수 있습니다.
          </Typography>
          <Typography
            display="block"
          ...
          >
            객관식, 서술형, 단답형 문제들을 출제하고 다른 유저들이 퀴즈를
            수행하면,
          </Typography>
          <Typography
            display="block"
        ...
        <Grid item xs={5} className="reveal fade-bottom">
          ...
          >
            영어에서 중요하거나 자신이 모르는 어휘들을 어휘단어장에 하나씩
            등록해보세요.
          </Typography>
          <Typography
            display="block"
        ...
        <Grid item xs={5} className="reveal fade-bottom">
          ...
          >
            다른 유저들을 조회, 친구 연결 및 영어 학습과정에서의 피드백이 필요한
            경우 메세지를 주고받을 수 있습니다.
          </Typography>
          <Typography
            display="block"
