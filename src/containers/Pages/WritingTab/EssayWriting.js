...
function EssayWriting(props) {
    ...
    useEffect(() => {
        if(isLoaded) {
            axios
                .get(baseURL+"writing/define-essay-editor/"+id+"/"+userid, { //첨삭가능한 친구 목록 불러오기.
                    headers: {
            ...
            axios
            .get(baseURL+"writing/check-if-essay-participant-user/"+id+"/"+userid, {
                headers: {
                Authorization: localStorage.getItem('token')
                    ? 'Token ' + localStorage.getItem('token')
                    : null,
            ...
            .then(res => {
                ...
                if(res["data"]["editable"] != true) {
                    ...
                    axios
                        .get(baseURL+"writing/get-essay-writing-data/view/"+id+"/"+userid, {
                            headers: {
                            Authorization: localStorage.getItem('token')
                                ? 'Token ' + localStorage.getItem('token')
                                : null,
                    ...
                    console.log("true");
                    axios
                        .get(baseURL+"writing/get-essay-writing-data/edit/"+id+"/"+userid, {
                            headers: {
                            Authorization: localStorage.getItem('token')
                                ? 'Token ' + localStorage.getItem('token')
                                : null,
    ...
    const handleSubmitComment= (data) => {
        console.log(data);
        axios
          .post(baseURL+"writing/submit-essay-comment/"+id+"/"+userid , { 
            submitData: data,
            roomUserEmail: email
          },
          {
    ...
    const handleSubmitEditorButton= () => {
        ...
        axios
            .post(baseURL+"writing/define-essay-editor/"+id+"/"+userid , { 
